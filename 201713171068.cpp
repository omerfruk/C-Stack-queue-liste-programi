...
/*
buradaki algoritmada yapmaya calistigim bir node verisi olusturmak istedigimizde direk olarak degerler atansın 
ve baglamaları otomatik olarak yapilsin fakat tam olarak yapamadim
*/
	...
	{																// surekli bu menude kalmak icin gerekli dongu
		...
		cin >> choice;												// degiskene kullanicidan deger isteyelim
			...
			{	
				...
				while (StackManu)
				{					// menude kalmak icin dongu kuralım
			...
			{					   
				...
				{																// queue menumuzu surekli gormek icin bir dongu yazalim
					cout << "-------------Queue Menu---------------" << endl;	//menu yazdır
					cout << " Yapmak istediginiz islemi seciniz:   " << endl;	//menu yazdır
					cout << "/ 1.Kuyruga eleman ekle 			" << endl; //menu yazdır
					cout << "/ 2.Kuyruktan  eleman cikar		" << endl; //menu yazdır
					cout << "/ 3.Kuyrugu temizle				" << endl; //menu yazdır
					cout << "/ 4.Kuyruktaki elemanlari goster  	" << endl;		//menu yazdır
					cout << "/ 5.kuyruktaki eleman sayisini goster" << endl;	//menu yazdır
					cout << "/ 6.Ana menuye don 				" << endl; //menu yazdır
					cout << "--------------------------------------" << endl;	//menu yazdır
			...
			case 3:
			{
				...
				value1->pNextValue = value2; // veri tipimiz liste oldugu icin 2 bogumlu bir kutu dusunup bir kutumuzun icine deger verirken diger kutumuzun icine bir sonraki verimizin adresini atıyalım
